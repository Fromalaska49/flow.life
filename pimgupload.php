...
$sql = "INSERT INTO `imgurls` (`uid`, `url`, `time`)
VALUES ('$uid', '$location', '$time')";
mysql_query($sql);

$sqla = "UPDATE `users`
SET `ppimgurl`='$location'
WHERE `id`='$uid'";
...
$annotation = mysql_real_escape_string("<a href=\"profile.php?id=" . $uid . "\" style=\"color:rgb(0,119,0);\">" . $name . "</a> changed " . $their . " profile picture.<br />");
