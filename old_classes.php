			...
			<center>
				...
				<div>
					...
					while ($row = mysql_fetch_array($result)) {
						...
						echo('<a href="class.php?id=' . $classid . '"><img src="' . $pimgurl . '" style="float:left;border-color:white;border-style:solid;border-width:5px;margin:10px;box-shadow:0px 3px 14px -2px black;" /></a>');
						echo('<p style="text-shadow:0px 1px 0px white;">' . $cname . '</p></div>');
					}
					?>
				</div>
			</center>
