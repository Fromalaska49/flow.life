				...
				<div id="feedbody">
					<div id="userposts" class="mainuserposts" style="">
						<div style="width:296px;height:22px;border-radius:100px;background-color:;box-shadow:0px 2px 6px 0px black">
							<div class="mupswitch" onmousedown="this.className='mupswitchactive'" onmouseout="this.className='mupswitch'" onmouseup="this.className='mupswitch'" onclick="window.location='group.php?id=<?php echo($_GET["id"])?>';" style="border-radius:100px 0px 0px 100px;">
								Forum
							</div>
							<div class="mupswitchactive" onclick="window.location='groupannouncements.php?id=<?php echo($_GET["id"])?>';" style="border-radius:0px 100px 100px 0px;">
								Announcements
							</div>
						</div>
					<br />
					...
					WHERE groupid='$profiledgroup' AND fid='$tid'
					ORDER BY time DESC
					LIMIT 20";
					$result2a = mysql_query($sql2a);
