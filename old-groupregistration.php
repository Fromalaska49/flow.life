	...
	<body style="padding:0px;margin:0px;overflow:hidden;" onload="widthcalc()">
		...
		<div class="feed" id="feed" style="overflow-x:hidden;position:relative;top:30px;">
			<center>
				...
				<br />
				<br />
				<div style="height:50px;text-shadow:0px 1px #EAEAEA;" id="">
...
<form action="registergroup.php" method="post" enctype="multipart/form-data">
<table style="border-style:none;float:left;">
	<tr>
		...
		<td>
			<input type="radio" name="gtype" value="group" onclick="document.getElementById('period').style.display='none';" />Group
			<input type="radio" name="gtype" value="class" onclick="document.getElementById('period').style.display='';" />Class
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<input type="text" name="gname" style="width:200px;padding:7px;box-shadow:inset 0px 1px 20px -3px black;border-radius:1px;border-color:#CDCDCD #FFFFFF #FFFFFF #FFFFFF;border-style:solid;border-width:2px;font-family:arial;" />
		</td>
	</tr>
	<tr style="display:none;" id="period">
		<td>
			Period
		</td>
		<td>
			<input type="radio" name="period" value="1" />1
			<input type="radio" name="period" value="2" />2<br />
			<input type="radio" name="period" value="3" />3
			<input type="radio" name="period" value="4" />4<br />
			<input type="radio" name="period" value="5" />5
			<input type="radio" name="period" value="6" />6<br />
			<input type="radio" name="period" value="7" />7
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<textarea class="textinput" size="128" maxlength="128" style="resize:none;height:100px;width:200px;padding:7px;box-shadow:inset 0px 1px 20px -3px black;border-radius:1px;border-color:#CDCDCD #FFFFFF #FFFFFF #FFFFFF;border-style:solid;border-width:2px;font-family:arial;overflow:hidden;" name="gabout"></textarea>
		</td>
	</tr>
	<tr>
		<td>
