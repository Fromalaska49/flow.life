			...
			<center>
				...
				<div>
					...
					while ($row = mysql_fetch_array($result)) {
						...
						echo('<a href="group.php?id=' . $groupid . '"><img src="' . $pimgurl . '" style="float:left;border-color:white;border-style:solid;border-width:5px;margin:10px;box-shadow:0px 3px 14px -2px black;" /></a>');
						echo('<p style="text-shadow:0px 1px 0px white;">' . $gname . '</p></div>');
					}
					?>
				</div>
			</center>
