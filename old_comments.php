			...
			<center>
				...
				<div style="position:relative;top:0px;z-index:5;">
					...
					while($myrow = mysql_fetch_array($result2a)){
						...
						echo ('<form action="comment.php" method="post"><div class="ccontnr" style="background-color:#777777;"><img style="height:40px;float:left;" src="' . $upimgurl . '" /><h4 class="ttl" style=""><div class="pcheader" style="float:left;">' . $ufname . ' ' . $ulname . '</div><div class="pcheader" style="float:right;height:20px;background-color:#AA0000;padding:10px;position:relative;top:-10px;right:-10px;" onclick="submit()">Post</div></h4></div><div class="ccontner"><textarea style="width:100%;height:75px;padding:5px;font-family:arial;" name="comment"></textarea></div><input type="text" style="display:none;" name="id" value="' . $pid . '" /></form>');
						echo ('</div><br />');
					};
					?>
				</div>
