			...
			<center>
				...
				<div style="height:50px;" id="">
					...
					<div style="float:right;">
						<form action="imageupload.php" method="post" enctype="multipart/form-data">
							<input type="file" name="file" id="file" multiple="2" />
				...
				<div>
					...
					while($row = mysql_fetch_array($result)) {
						$l = $row['url'];
						$url = "imgthumb/" . $l;
						echo('<a href="' . $l . '"><img src="' . $url . '" style="float:left;border-color:white;border-style:solid;border-width:5px;margin:10px;box-shadow:0px 3px 12px -2px black;" /></a>');
					}
					?>
				</div>
			</center>
