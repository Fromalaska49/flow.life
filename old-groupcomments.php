			...
			<center>
				...
				<div style="position:relative;top:0px;z-index:5;">
					...
					while($myrow = mysql_fetch_array($result2a)){
						...
						$time = htmlspecialchars($myrow["time"]);
						...
						echo ('<div class="cntnr" style=""><div class="contnr" style=""><a href="profile.php?id=' . $uid . '"><img style="height:40px;float:left;" src="' . $picurl . '" /><h4 class="ttl" style=""><div class="pcheader" style="float:left;">' . $fname . ' ' . $lname . '</div><div class="pcheader" style="float:right;">' . $num . '</div><div class="pcheader" style="float:right;">' . $time . '</div></h4></a></div><div class="contner">' . $post . '<div style="text-align:right;"><div style="display:inline;padding:5px;"><a href="classcomments.php?id=' . $pid . '" style="color:black;">Comment</a></div><div style="display:inline;padding:5px;" onclick="like(' . $pid . ')" id="' . $pid . '">' . $likable . '</div></div></div>');
						...
						while ($crow = mysql_fetch_array($cresult)) {
							...
							$cpicurl = "imghtumb/" . $crow["picurl"];
							if (!$crow["picurl"]) {
								$cpicurl = "ppdefault.jpg";
							}
							$comment = htmlspecialchars($crow["comment"]);
							$ctime = htmlspecialchars($crow["time"]);
						...
						echo ('<form action="groupcomment.php" method="post"><div class="ccontnr" style="background-color:#777777;"><img style="height:40px;float:left;" src="' . $_SESSION["pimgurl"] . '" /><h4 class="ttl" style=""><div class="pcheader" style="float:left;">' . $_SESSION["fname"] . ' ' . $_SESSION["lname"] . '</div><div class="pcheader" style="float:right;height:20px;background-color:#AA0000;padding:10px;position:relative;top:-10px;right:-10px;" onclick="submit()">Post</div></h4></div><div class="ccontner"><textarea style="width:100%;height:75px;padding:5px;font-family:arial;" name="comment"></textarea></div><input type="text" style="display:none;" name="id" value="' . $pid . '" /></form>');
						echo ('</div><br />');
					};
					?>
				</div>
