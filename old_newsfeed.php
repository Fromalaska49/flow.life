				...
				<ul style="list-style-type:none;">
					...
					if($num>0){
						while($row=mysql_fetch_array($result)){
							$churchid = $row["id"];
							$church=$row["name"];
							echo('<a href="church.php?id=' . $churchid . '"><li class="fmenuli">' . $church . '<img src="groups.png" style="height:20px;position:relative;left:-20px;top:5px;" /></li></a>');
						}
					}
					else{
						echo('<a href="search.php"><li class="fmenuli">Add Church<img src="groups.png" style="height:20px;position:relative;left:-20px;top:5px;" /></li></a>');
					}
					?>
