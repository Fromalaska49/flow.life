...
mysql_query("INSERT INTO `pageimgurls` (`pageid`, `url`, `time`) VALUES ('$pageid', '$location', '$time')");
mysql_query("UPDATE `pages` (`ppimgurl`) VALUES ('$location')");
$_SESSION['ppimgurl']=$location;

//echo("db insertion done<br />");

$annotation=mysql_real_escape_string("<a href=\"page.php?id=".$pageid."\" style=\"color:rgb(0,119,0);\">".$name."</a> changed its profile picture.<br />");
$post=mysql_real_escape_string($_POST['post']);
$media=mysql_real_escape_string($location);

$day = date('l');
$fid=0;
if(mysql_query("INSERT INTO `pageposts` (`fid`,`pageid`, `annotation`, `post`, `media`, `time`, `day`) VALUES ('$fid', '$pageid', '$annotation', '$post', '$media', '$time', '$day')")){
//echo(success);
}
else{
if(mysql_query("INSERT INTO `pageposts` (`fid`, `pageid`, `annotation`) VALUES ('$fid', '$pageid', '$annotation')")){
//echo('errant success<br />');
}
//echo('error');
}
