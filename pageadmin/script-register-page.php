...
if(isset($name)){
	...
	if(strlen(mysql_real_escape_string($_POST["tel"]))==10){
	...
	if(isset($streetaddress)&&isset($city)&&isset($state)&&isset($zipcode)){
	...
	$sql = "INSERT INTO `pages`(`id`, `password`, `name`, `church`, `email`, `tel`, `address`, `city`, `state`, `zipcode`, `ppimgurl`)
	VALUES ('','$password','$name','$church', '$email', '$tel', '$streetaddress','$city','$state','$zipcode', 'default-pimg.jpg')";
	mysql_query($sql);
