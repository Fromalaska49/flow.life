			...
			<center>
				...
				<div id="feedbody">
						<div style="width:296px;height:22px;border-radius:100px;background-color:;box-shadow:0px 2px 6px 0px black">
							<div class="mupswitch" onmousedown="this.className='mupswitchactive'" onmouseout="this.className='mupswitch'" onmouseup="this.className='mupswitch'" onclick="window.location='class.php?id=<?php echo($_GET["id"])?>';" style="border-radius:100px 0px 0px 100px;">
								Forum
							</div>
							<div class="mupswitchactive" onclick="window.location='classannouncements.php?id=<?php echo($_GET["id"])?>';" style="border-radius:0px 100px 100px 0px;">
								Announcements
							</div>
						</div>
					<br />
					...
					WHERE classid='$profiledclass' AND fid='$tid'
					ORDER BY time DESC
					LIMIT 20";
					$result2a = mysql_query($sql2a);
